...
from SpaceGrooveLevel5.objects import ObjectManager, Ship
from SpaceGrooveLevel5.resources import ResourceManager
...
class SpaceRoom5:
    def __init__(self, screen):
        ...
        pygame.mixer.music.load(os.path.join("SpaceGrooveLevel5","data","music","theme.wav"))
