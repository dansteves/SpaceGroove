...
from SpaceGrooveLevel2.objects import ObjectManager, Ship
from SpaceGrooveLevel2.resources import ResourceManager
...
class SpaceRoom2:
    def __init__(self, screen):
        ...
        pygame.mixer.music.load(os.path.join("SpaceGrooveLevel2","data","music","theme.wav"))
