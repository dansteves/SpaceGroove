...
def _loadSound(name, folder=os.path.join("SpaceGrooveLevel4", "data", "sounds")):
    class NoneSound:
        def play(self): pass
...
def _loadImage(name, folder=os.path.join("SpaceGrooveLevel4", "data","images"),colorkey=-1):
    fullname = os.path.join(folder, name)
    try:
...
def _loadSpritesheet(name,
                    ...
                    imagesize=(16,16),
                    count=8,
                    folder=os.path.join("SpaceGrooveLevel4", "data","images")):
...
class _ResourceManager:
    def __init__(self,
                 imgpath=os.path.join("SpaceGrooveLevel4", "data","images"),
                 sndpath=os.path.join("SpaceGrooveLevel4", "data","sounds")):
...
if __name__ == "__main__":
    try:
        ...
        pygame.mixer.music.load(os.path.join("SpaceGrooveLevel4", "data","music","theme.mid"))
