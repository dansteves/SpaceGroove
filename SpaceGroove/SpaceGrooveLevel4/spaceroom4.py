...
from SpaceGrooveLevel4.objects import ObjectManager, Ship
from SpaceGrooveLevel4.resources import ResourceManager
...
class SpaceRoom4:
    def __init__(self, screen):
        ...
        pygame.mixer.music.load(os.path.join("SpaceGrooveLevel4","data","music","theme.wav"))
